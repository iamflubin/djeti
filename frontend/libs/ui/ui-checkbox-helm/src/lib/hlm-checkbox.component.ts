...
export class HlmCheckboxComponent implements ControlValueAccessor {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'group inline-flex shrink-0 cursor-pointer items-center rounded-sm border border-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring' +
        ' focus-visible:ring-offset-2 focus-visible:ring-offset-background data-[state=checked]:bg-primary data-[state=unchecked]:bg-background data-[state=checked]:text-background',
      this.userClass(),
