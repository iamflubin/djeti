...
export class HlmDatePickerComponent<T> {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'inline-flex h-10 w-[280px] items-center justify-start gap-2 whitespace-nowrap rounded-md border border-input bg-background px-4 py-2 text-left text-sm font-normal ring-offset-background transition-colors hover:bg-accent hover:text-accent-foreground',
