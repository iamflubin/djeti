...
export class HlmSelectOptionComponent {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'rtl:flex-reverse relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[active]:bg-accent data-[active]:text-accent-foreground data-[disabled]:opacity-50 rtl:pl-2 rtl:pr-8',
      this.userClass()
    )
  );
}
