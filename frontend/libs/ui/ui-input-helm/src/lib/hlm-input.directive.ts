...
export const inputVariants = cva(
  'flex rounded-md border border-input bg-transparent text-base font-normal ring-offset-background file:border-0 file:bg-transparent file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
  {
    variants: {
      size: {
        default: 'h-10 px-4 py-2 file:max-md:py-0',
        sm: 'h-9 px-3 file:max-md:py-1.5 file:md:py-2',
        lg: 'h-11 px-8 file:max-md:py-2.5 file:md:py-3',
      },
      error: {
